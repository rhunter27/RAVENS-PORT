    ...
    <div className="about-page" data-theme={theme}>
      ...
      <div className="about-page__content">
        <div className="about-page__story">
          <h2 className="about-page__section-heading">My Story</h2>
          ...
          <p className="about-page__text">
            Raven Hunter is a versatile professional with 13+ years in sales and customer service,
            now expanding into technical fields through completion of Rice University's 6-month coding bootcamp.
            Combines extensive retail expertise (jewelry, fashion, healthcare) with newly acquired programming skills
            to bridge business and technology. Proven track record in driving sales (achieved 10% increase at Zales)
            while developing technical competencies in full-stack development, data analysis, and system troubleshooting.
          </p>
        </div>

        <div className="about-page__values">
          <h3 className="about-page__values-heading">My Values</h3>
          ...
          {/* ✅ Correct Learn More Link */}
          <Link to="/learn-more" className="about-page__learn-more-btn">
            LEARN MORE
          </Link>
        </div>
      </div>
